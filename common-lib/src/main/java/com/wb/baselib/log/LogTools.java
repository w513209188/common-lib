...
public final class LogTools {
     ...
     * 默认tag
     */
    private final static String DEFAULT_LOG_TAG = "[log---->]";
    /**
    ...
    private static boolean enableLog(int logPriority) {
        ...
        Log.e("logPriority",logPriority+"---");
        boolean oo=sILogger != null && sIsDebug && logPriority >= sLogPriority;;
        Log.e("oo",oo+"----"+sLogPriority);
        return oo;
